...
wget https://www.dropbox.com/s/lybd5hjb95p6zpg/amonit_theme.zip
...
cd /tmp/amonit/
unzip -o amonit_theme.zip -d /usr/local/nagios/share/
...
Executing /sbin/chkconfig npcd on on
